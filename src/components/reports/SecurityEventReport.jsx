...
const SecurityEventReport = ({ reportData, dateRange, generatedBy }) => {
    if (!reportData) return null;

    return (
        <div className="space-y-6">
            <ReportHeader title="Security Event Report" dateRange={dateRange} generatedBy={generatedBy} />
...
export default SecurityEventReport;